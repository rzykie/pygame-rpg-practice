...
class Boss(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.x = x * TILESIZE
        self.y = y * TILESIZE
        self.width = BOSS_TILESIZE
        self.height = BOSS_TILESIZE
        ...
        self.image = self.game.boss_spritesheet.get_sprite(61, 70, self.width, self.height).convert_alpha()
    ...
    def animate(self):
        ...
        if self.facing == "left":
            if self.x_change == 0:
                self.image = self.game.boss_spritesheet.get_sprite(0, 71, self.width, self.height).convert_alpha()
            else:
        ...
        if self.facing == "right":
            if self.x_change == 0:
                self.image = self.game.boss_spritesheet.get_sprite(0, 0, self.width, self.height).convert_alpha()
            else:
...
class MainMenuButton:
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        self.font = pygame.font.Font('Storm Gust.ttf', fontsize)
